...
6. Leave the new backlog issue unassigned. The implementation workflow assigns it to the pull-request author after the pull request exists and its exact-head CI succeeds.
...
6. Leave the issue unassigned and do not request a reviewer. The implementation workflow owns assignment after a pull request exists.
