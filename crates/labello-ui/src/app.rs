...
pub(crate) struct RuntimeState {
    ...
    pub reservation_cleanup: crate::live::ReservationCleanup,
...
impl RuntimeState {
    fn new() -> Self {
        ...
        Self {
            ...
            reservation_cleanup: Default::default(),
            repaint_ctx: None,
            error: None,
            storage_error: None,
            notice: None,
...
pub(crate) struct DatasetState {
    ...
    pub leaderboard: crate::statistics::LeaderboardState,
    pub stats_request_id: u64,
    pub active_stats_request: Option<(u64, DatasetId)>,
    pub refresh_stats_after_load: bool,
...
impl DatasetState {
    fn new() -> Self {
        Self {
            ...
            refresh_stats_after_load: false,
