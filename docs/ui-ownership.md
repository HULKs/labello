...
last keypoint active for replacement. Both ordinary and migration canvas adapters
...
identity. The shared review footer owns Confirm / Submit review and Previous, Discard and
