...
| [Browser verification](browser-verification.md) | Normative current | UI maintainers | Contributors, reviewers | Disposable Chromium workflows, display matrix, artifacts, and inspector/workflow parity |
