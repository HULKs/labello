...
- Assignment balance can enforce either a completion ratio or an absolute
  completion-count window across enabled tasks. It does not separately
  aggregate and enforce class-level balance when multiple tasks share a class.
