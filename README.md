...
- [Prelabels](docs/prelabels.md) support the documented static detection/pose ONNX
  tensor contract, including compatible exports without Ultralytics metadata,
